...
<template>
  ...
  <UiTitleCard title="Productos Asociados" class-name="px-0 pb-0"
    v-if="USER_ROL === 1 || USER_ROL === 2 || USER_ROL === 3 || USER_ROL === 4 || USER_ROL === 5 || USER_ROL === 6 || USER_ROL === 7 || USER_ROL === 8 || USER_ROL === 9 || USER_ROL === 99 || Type !== 'DETALLE DE ENVIO'">
