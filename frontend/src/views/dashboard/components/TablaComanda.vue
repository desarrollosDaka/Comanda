          ...
          <v-dialog v-model="dialog" max-width="600px">
            <v-card>
                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" md="6" sm="6">
                      <v-label class="mb-3" text="CED/RIF"></v-label>
                      <br>
                      <span class="caption">{{ editedItem.Cedula }}</span>
                    </v-col>

                    <v-col cols="12" md="6" sm="6">
                      <v-label class="mb-3" text="Sucursal"></v-label>
                      <br>
                      <span class="caption">{{ editedItem.Sucursal }}</span>
                    </v-col>

                    <v-col cols="12" md="6" sm="6">
                      <v-label class="mb-4" text="ESTATUS"></v-label>
                      <br>
                      <v-chip variant="tonal" color="warning" size="small" prepend-icon="mdi-timer-sand"
                      ...
                      <v-chip variant="tonal" color="warning" size="small" prepend-icon="mdi-timer-sand" v-else>
                        <p class="mb-0">Creada</p>
                      </v-chip>
                    </v-col>
              ...
              <v-card-actions>
                ...
                <v-btn type="submit" color="primary" variant="elevated" @click="asignAsesor(editedItem.ID_order)">
                  Guardar Cambios
                </v-btn>
              </v-card-actions>
            </v-card>
