...
const ciudad_repNombre = ref();
const municipio_rep = ref();
const municipio_repNombre = ref();
...
async function searchModel() {
  try {
    ...
    if (data) {
      ...
      ciudadNombre.value = data[0][0].Nombre_city;
      ...
      ciudad_repNombre.value = data[0][0].Nombre_city_rep;
      municipio_rep.value = data[0][0].ID_municipio_rep;
      municipio_repNombre.value = data[0][0].Nombre_municipio_rep;
