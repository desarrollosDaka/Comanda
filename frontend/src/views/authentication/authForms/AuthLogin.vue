...
const errors = ref<string>('contraseña incorrecta');
  ...
  <Form @submit="validate" class="mt-7 loginForm" v-slot="{ errors, isSubmitting }">
    ...
    <div>
      ...
      <v-text-field aria-label="password" v-model="Password" :rules="passwordRules" required variant="outlined"
        color="primary" hide-details="auto" :type="show1 ? 'text' : 'password'" class="pwdInput mt-2">
    ...
    <div class="d-flex align-center mt-4 mb-7 mb-sm-0">
      <v-checkbox v-model="remenberMe" :rules="[(v: any) => !!v || 'You must agree to continue!']" label="Recordar"
